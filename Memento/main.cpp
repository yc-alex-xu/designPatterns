...
public:
    ...
    MementoType Save()
    {
        std::string content_saved = content_;
        content_ = "";
        return std::make_shared<EditorMemento>(content_saved);
    }
...
/*
the https://pushmind.org/2017/07/31/design-patterns-for-humans/   seem incorrect
refer  https://en.wikipedia.org/wiki/Memento_pattern  
 */
